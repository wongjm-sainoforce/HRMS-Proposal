...
**Live:** https://wongjm-sainoforce.github.io/HRMS-Proposal/

Or open `index.html` in any modern browser — it is a single, self-contained file (no install, no build step).
...
- **Arrow keys / Space / Page Up–Down** — move between slides
- **Swipe** — on touch devices
- **Home / End** — jump to first / last slide
- **E** — toggle inline edit mode (click any text to change it; **Ctrl+S** saves a copy)

## Customising

- Colours, fonts and spacing are CSS variables in the `:root` block at the top of `index.html`.
- The deck is built as a fixed **1920×1080** stage that scales to any screen (16:9, letterboxed on other ratios).
